...
const PaletteModal = ({ref, style, setBackground}) => {
  return (
    <div ref={ref} style={style} className={cl.palette__modal}>
      <span style={{background: '#252525'}} className={cl.palette__modal__color} onClick={() => setBackground({background: '#252525'})}></span>
      <span style={{background: '#2A1258'}} className={cl.palette__modal__color} onClick={() => setBackground({background: '#2A1258'})}></span>
